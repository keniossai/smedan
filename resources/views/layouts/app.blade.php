...
<html lang="en">
  <head>
    ...
    <link href="{{ asset('assets/css/dashboard/bootstrap.min.css') }}" rel="stylesheet" />

    <link href="{{ asset('assets/css/dashboard/bootstrap-icons.css') }}" rel="stylesheet" />


    <link href="{{ asset('assets/css/dashboard/fontawesome.min.css') }}" rel="stylesheet" />
  ...
  <header class="header-area style-1 dashboard-header">
    <div class="mobile-logo-area d-lg-none d-flex justify-content-between align-items-center">
      <div class="mobile-logo-wrap">
        <a href="index.html"><img alt="image" src="{{ asset('assets/images/logo/smedan.png') }}" /></a>
      </div>
    </div>
    ...
    <div class="dashboard-sidebar-wrapper">
      <div class="dashboard-sidebar-logo">
        <a href="index.html">
          <img
            ...
            src="assets/img/dashboard/icon/dashboard-sidebar-logo.svg"
            alt
          />
        </a>
        <a href="index.html">
          <img
            ...
            src="assets/img/dashboard/icon/dashboard-sidebar-sm-logo.svg"
            alt
          />
        </a>
      </div>
      <div class="dashboard-sidebar-menu">
        <ul>
          ...
          <li>
            <a href="dashboard-my-listing.html">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="18"
                height="18"
              ...
              >
                ...
                <g mask="url(#mask0_920_506)">
                  <path
                    d="M1.56532 2.57153C0.700975 2.57153 0 3.28957 0 4.17565C0 5.06109 0.700975 5.77853 1.56532 5.77853C2.42966 5.77853 3.13063 5.06109 3.13063 4.17565C3.13063 3.28957 2.42966 2.57153 1.56532 2.57153Z"
                  />
                  <path
                    d="M1.56532 7.39502C0.700975 7.39502 0 8.11246 0 8.99854C0 9.88397 0.700975 10.602 1.56532 10.602C2.42966 10.602 3.13063 9.88397 3.13063 8.99854C3.13063 8.11246 2.42966 7.39502 1.56532 7.39502Z"
                  />
                  <path
                    d="M1.56532 12.2214C0.700975 12.2214 0 12.9395 0 13.8249C0 14.7104 0.700975 15.4284 1.56532 15.4284C2.42966 15.4284 3.13063 14.7104 3.13063 13.8249C3.13063 12.9395 2.42966 12.2214 1.56532 12.2214Z"
                  />
                  <path
                    d="M16.8214 2.9707H5.68684C5.03685 2.9707 4.50977 3.51065 4.50977 4.1771C4.50977 4.84299 5.03681 5.38289 5.68684 5.38289H16.8214C17.4714 5.38289 17.9985 4.84299 17.9985 4.1771C17.9985 3.51065 17.4714 2.9707 16.8214 2.9707Z"
                  />
                  <path
                    d="M16.8214 7.79199H5.68684C5.03685 7.79199 4.50977 8.3319 4.50977 8.99839C4.50977 9.66428 5.03681 10.2042 5.68684 10.2042H16.8214C17.4714 10.2042 17.9985 9.66428 17.9985 8.99839C17.9985 8.3319 17.4714 7.79199 16.8214 7.79199Z"
                  />
                  <path
                    d="M16.8214 12.6172H5.68684C5.03685 12.6172 4.50977 13.1571 4.50977 13.823C4.50977 14.4888 5.03681 15.0287 5.68684 15.0287H16.8214C17.4714 15.0287 17.9985 14.4888 17.9985 13.823C17.9985 13.1571 17.4714 12.6172 16.8214 12.6172Z"
                  />
                </g>
              </svg>
              <h6>All Posts</h6>
  ...
  <script src="{{ asset('assets/js/dashboard/swiper-bundle.min.js')}}"></script>
  <script src="{{ asset('assets/js/dashboard/slick.js') }}"></script>

  <script src="{{ asset('assets/js/dashboard/waypoints.min.js')}}"></script>
  ...
  <script src="{{ asset('assets/js/dashboard/jquery.nice-select.min.js') }}"></script>
